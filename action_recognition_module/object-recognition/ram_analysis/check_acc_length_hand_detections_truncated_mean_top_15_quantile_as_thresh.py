...
ram_plus_thresholds = torch.load('default_thresholds.pt') #'/cluster/project/cvg/students/azaera/ram_plus_outputs/class_thresholds.pt'
...
for noun_label in range(521):
    ...
    for clip_uid, action_idx in tqdm(to_run):
        ...
        try:
            logits = torch.load(os.path.join(ram_plus_base_outputs_path, 'aggregated_logits_hand_boxes_mapped_ego4d.pt')) #max_logits_hand_boxes_mapped_ego4d #trunc-mean-3_logits_hand_boxes_max-per-frame_mapped_ego4d.pt
